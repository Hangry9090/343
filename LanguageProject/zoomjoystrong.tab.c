...
static const char *const yytname[] =
{
  ...
  "statement", "term", "end", "point", "line", "circle", "rectangle",
...
static const yytype_int8 yypact[] =
{
     ...
     -10,   -10,   -10,   -10,   -10,   -10,     4,     5,     6,     7,
       8,   -10,   -10,    13,    15,    10,    11,    14,    16,   -10,
      17,    18,    19,    21,    24,   -10,    26,   -10,   -10,   -10
};
...
static const yytype_int8 yytable[] =
{
      ...
      19,    20,    21,    -2,    24,    25,    26,    27,    28,    29,
      30,    31,    35,     0,    32,    37,    33,    34,    38,    36,
      39,    22,     0,    23
};
...
static const yytype_int8 yycheck[] =
{
      ...
      10,    10,     0,     0,    10,    10,    10,    10,    10,     4,
      10,    10,     4,    -1,    10,     4,    10,    10,     4,    10,
       4,     8,    -1,     8
};
...
#line 55 "zoomjoystrong.y" /* yacc.c:1646  */
    {
		...
		if((yyvsp[-2].i) < 0 || (yyvsp[-2].i) > HEIGHT){
...
#line 70 "zoomjoystrong.y" /* yacc.c:1646  */
    {	
		...
		else if((yyvsp[-2].i) < 0 || (yyvsp[-2].i) > WIDTH){
			printf("The third number is not within the screen.");
		}
		else if((yyvsp[-1].i) < 0 || (yyvsp[-1].i) > WIDTH) {
...
#line 91 "zoomjoystrong.y" /* yacc.c:1646  */
    {
		...
		else if((yyvsp[-3].i) + (yyvsp[-1].i) > WIDTH || (yyvsp[-3].i) - (yyvsp[-1].i) < 0) {
			printf("Part of the circle will appear off the screen");

		}
		else if((yyvsp[-2].i) + (yyvsp[-1].i) > HEIGHT || (yyvsp[-2].i) - (yyvsp[-1].i) < 0) {
			printf("Part of the circle will appear off the screen.");
		}
		else {
...
#line 1299 "zoomjoystrong.tab.c" /* yacc.c:1646  */
  ...
  case 14:
#line 112 "zoomjoystrong.y" /* yacc.c:1646  */
    {
		if((yyvsp[-4].i) < 0 || (yyvsp[-4].i) > WIDTH) {
			printf("The first number is not within the screen.");
		}
		else if((yyvsp[-4].i) < 0 || (yyvsp[-4].i) > HEIGHT) {
			printf("The first number is not within the screen.");
		}
		else if((yyvsp[-3].i) < 0 || (yyvsp[-3].i) > WIDTH){
			printf("The second number is not within the screen.");
		}
		else if((yyvsp[-3].i) < 0 || (yyvsp[-3].i) > WIDTH) {
			printf("The second number is not within the screen.");
...
#line 1333 "zoomjoystrong.tab.c" /* yacc.c:1646  */
  ...
  case 15:
#line 144 "zoomjoystrong.y" /* yacc.c:1646  */
    {
